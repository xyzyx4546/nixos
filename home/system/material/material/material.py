...
def render_templates(colors_list):
    ...
    if os.path.exists(f"{HOME_DIR}/.config/WebCord/Themes"):
        shutil.copyfile(f"{COLORS}/colors-webcord.css", f"{HOME_DIR}/.config/WebCord/Themes/webcord.theme")
    # if os.path.exists(f"{HOME_DIR}/.config/spotify-player"):
    #     shutil.copyfile(f"{COLORS}/colors-spotify_player.toml", f"{HOME_DIR}/.config/spotify-player/theme.toml")
